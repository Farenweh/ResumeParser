...
urlset1 = {"/api/ocr/v1/webimage", "/api/ocr/v1/idcard", "/api/ocr/v1/businesslicense", "/api/ocr/v1/enterpriselicense",
           "/api/ocr/v1/generic", \
           "/api/ocr/v1/trainticket", "/api/ocr/v1/invoice", "/api/ocr/v1/licenseplate", "/api/ocr/v1/ammeter",
           "/api/ocr/v1/seal"}

urlset2 = {"/api/ocr/v1/general", "/api/ocr/v1/handwriting", "/api/ocr/v1/bankcard", "/api/ocr/v1/businesscard",
           "/api/ocr/v1/form", \
           "/api/ocr/v1/taxiinvoice", "/api/ocr/v1/fixedinvoice", "/api/ocr/v1/flights", "/api/ocr/v1/toll",
           "/api/ocr/v1/mixedbills", "/api/ocr/v1/sealrecognition", \
